...
import { apiBaseUrl, downloadParams, fetchEvents, type AIEvent, type EventFilters } from "@/lib/api";
...
function filtersFromSearchParams(searchParams: PageProps["searchParams"]): EventFilters {
  return {
    project_id: firstParam(searchParams?.project_id) || "prj_demo_feature",
